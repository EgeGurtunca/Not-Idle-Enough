...
export const STR = {
  en: {
    ...
    crash_reload: 'Reload',
    tip_dismiss: 'Dismiss',
    tip_click: 'Tap the creature to attack. Every kill pays gold.',
    tip_hire: 'You can afford a companion — hire one in Companions. They fight while you are away.',
    tip_boss: 'The pack is cleared. Challenge the boss to advance a region — but beat it before the timer runs out.',
    tip_prestige: 'Region 100 reached. Prestige resets the run for crystals and permanent upgrades — that is how you climb higher.',
    tip_transcend: 'Region 500. Ascension is open: it resets crystals too, but grants Stardust and far stronger multipliers.',
    tip_realm: 'Region 1000. Realm Shift takes you to a new realm from Region 1, doubling all damage and gold for good.',
    set_volume: 'Volume',
    set_fx3d: '3D Creatures', set_fx3d_sub: 'Turn off to save battery and CPU — creatures show as emoji',
  ...
  tr: {
    ...
    crash_reload: 'Yenile',
    tip_dismiss: 'Kapat',
    tip_click: 'Saldırmak için yaratığa tıkla. Her ölüm altın kazandırır.',
    tip_hire: 'Bir yoldaş alabilirsin — Yoldaşlar sekmesinden işe al. Sen yokken de savaşırlar.',
    tip_boss: 'Sürü temizlendi. Bölge atlamak için boss\'a meydan oku — ama süre dolmadan yen.',
    tip_prestige: 'Bölge 100\'e ulaştın. Prestij koşuyu sıfırlar, karşılığında kristal ve kalıcı geliştirmeler verir — daha yükseğe böyle çıkılır.',
    tip_transcend: 'Bölge 500. Aşkınlık açıldı: kristalleri de sıfırlar ama Yıldız Tozu ve çok daha güçlü çarpanlar verir.',
    tip_realm: 'Bölge 1000. Diyar Geçişi seni Bölge 1\'den yeni bir diyara götürür; tüm hasar ve altın kalıcı olarak ikiye katlanır.',
    set_volume: 'Ses Seviyesi',
    set_fx3d: '3B Yaratıklar', set_fx3d_sub: 'Kapatınca pil ve işlemci tasarrufu — yaratıklar emoji olarak görünür',
...
export const EN = {
  ...
  mod: { zirhli: ['Armored', 'Resists NPC damage — your clicks matter!'], aceleci: ['Hasty', 'Short timer but low HP'], hazineci: ['Treasure', 'Very tanky but five times the reward'], ofkeli: ['Enraged', 'Timer drains faster'],
    afZirhli: ['Armored', 'Resists NPC damage but drops more gold'], afSiskin: ['Bloated', 'Triple HP, quadruple gold'], afCevik: ['Swift', 'Half HP, slightly more gold'], afUgurlu: ['Lucky', 'Six times the gold'] },
  skill: { ofke: ['Rage', 'Click damage ×5'], altinYagmuru: ['Gold Rain', 'Gold gain ×3'], zamanDonmasi: ['Time Freeze', 'Boss timer freezes'], savasEmri: ['War Cry', 'NPC damage ×3'], kaderDarbesi: ['Fatestrike', 'All damage ×8'], kusursuzNisan: ['Perfect Aim', 'Every click crits'] },
