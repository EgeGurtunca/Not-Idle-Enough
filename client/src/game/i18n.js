...
export const STR = {
  en: {
    ...
    tab_transcend: 'Ascension', tab_achievements: 'Achievements', tab_settings: 'Settings',
    loading: 'Opening the dungeon gates…',
    // TopBar
    record: 'Record · Region {n}', record_run: ' · run {n}',
    op_title: 'Test mode: click damage 1e300, gold & crystal gain ×1000',
    ...
    set_reset: 'Reset Game', set_reset_sub: 'Everything is wiped — backups stay, reversible',
    ...
    msg_imported: 'Save imported and written to the server.',
    msg_import_fail: "Could not read file: not a valid save JSON.",
    msg_restored: 'Backup restored.', msg_restore_fail: 'Could not restore backup.',
    msg_reset: 'Game reset. (You can roll back from the backups above if needed.)',
    // Offline modal
    ...
    // toasts (store)
    toast_ach: '🏆 Achievement: {emoji} {name}{extra}',
  ...
  tr: {
    ...
    tab_transcend: 'Aşkınlık', tab_achievements: 'Başarım', tab_settings: 'Ayarlar',
    loading: 'Zindan kapıları açılıyor…',
    record: 'Rekor · Bölge {n}', record_run: ' · {n}. macera',
    op_title: 'Test modu: klik hasarı 1e300, altın ve kristal kazancı ×1000',
    ...
    set_reset: 'Oyunu Sıfırla', set_reset_sub: 'Her şey silinir — yedekler durur, geri dönülebilir',
    ...
    msg_imported: 'Kayıt içe aktarıldı ve sunucuya yazıldı.',
    msg_import_fail: "Dosya okunamadı: geçerli bir kayıt JSON'u değil.",
    msg_restored: 'Yedek geri yüklendi.', msg_restore_fail: 'Yedek geri yüklenemedi.',
    msg_reset: 'Oyun sıfırlandı. (Gerekirse yukarıdaki yedeklerden geri dönebilirsin.)',
    ...
    toast_ach: '🏆 Başarım: {emoji} {name}{extra}',
